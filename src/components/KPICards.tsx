...
export default function KPICards({ kpis }: KPICardsProps) {
  const outcomeCards: CardItem[] = [
    ...
    },
    {
      ...
      value: 'Yes - All Packages',
      icon: Truck,
      tone: 'light-red',
      tooltip: 'Mobilization advance has been taken for: Flood Package-1, Flood Package-2, Flood Package-3, Flood Package-4, and Flood Package-5.',
    },
  ];
